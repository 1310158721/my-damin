<template>
  <el-dialog
    ...
    >
      ...
      <el-form-item size='small' label="权限菜单：" prop='permission' v-if='menuList'>
        <el-tree
          :data="menuList"
          show-checkbox
          node-key="permission"
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button size='small' type="primary" @click="surePermissionDialog">确 定</el-button>
    </span>
  </el-dialog>
</template>
    ...
    handleDialogOpen() {
      this.getSingleUser(this.id)
        .then((res) => {
          ...
          if (status === 0) {
            this.editPermissionModel = Object.assign({}, result, { permission: result.permission.split(',') });
